...
import numpy as np
from . import detector, recognizer, tools
...
class Pipeline:
    ...
    def __init__(
        self, detector_model=None, recognizer_model=None, scale=2, max_size=2048
    ):
        if detector_model is None:
            detector_model = detector.Detector()
        if recognizer_model is None:
            recognizer_model = recognizer.Recognizer()
        self.scale = scale
        self.detector = detector_model
        self.recognizer = recognizer_model
